    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama_rumahsakit" id="inputAddress2" value="{{ $laykes->nama_rumahsakit }}" placeholder="Nama Rumah Sakit">
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="inputPassword4">Latitude</label>
            <input type="text" name="latitude" class="form-control" id="latitude" value="{{$laykes->latitude}}" placeholder="Latitude">
          </div>
          <div class="form-group col-md-6">
            <label for="inputEmail4">Longitude</label>
            <input type="text" name="longitude" class="form-control" id="longitude" value="{{$laykes->longitude}}" placeholder="Longitude">
          </div>
        </div>
        <div class="form-group">
          <label for="inputAddress">Alamat</label>
          <input type="text" class="form-control" name="alamat" id="inputAddress" value="{{$laykes->alamat}}" placeholder="Alamat Lengkap">
        </div>
        <div class="form-group">
          ...
          <select id="inputState" class="form-control" name="id_wilayah">
            ...
            <option value="{{ $data->id }}" {{$data->id == $laykes->id_wilayah ? 'selected' : ''}}>{{ $data->nama }}</option>
          @endforeach
          </select>
        </div>
        <div class="form-group">
          ...
          <select id="inputState" class="form-control" name="id_kecamatan">
            ...
            <option value="{{$data->id}}" {{$data->id == $laykes->id_kecamatan ? 'selected' : ''}}>{{ $data->nama }}</option>
          @endforeach
          </select>
        </div>
        <div class="form-group">
          ...
          <select id="inputState" class="form-control" name="id_kelurahan">
            ...
            <option value="{{ $data->id }}" {{$data->id == $laykes->id_kelurahan ? 'selected' : ''}}>{{ $data->nama }}</option>
          @endforeach
          </select>
        </div>
        <div class="form-group">
          <label for="inputAddress2">No. Telpon</label>
          <input type="text" name="no_telpon" class="form-control" id="inputAddress2" value="{{$laykes->no_telpon}}" placeholder="No. Telpon">
        </div>
        <div class="form-group">
          <label for="inputAddress2">Jumlah Kamar</label>
          <input type="text" name="jumlah_kamar" class="form-control" id="inputAddress2" value="{{$laykes->jumlah_kamar}}" placeholder="Jumlah Kamar">
        </div>
      </div>
