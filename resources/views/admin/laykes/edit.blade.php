    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('nama_rumahsakit') is-invalid @enderror" name="nama_rumahsakit" id="inputAddress2"
          value="{{ $laykes->nama_rumahsakit }}" placeholder="Nama Rumah Sakit" required>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            value="{{$laykes->latitude}}" placeholder="Latitude" required>
            @error('latitude')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group col-md-6">
            ...
            value="{{$laykes->longitude}}" placeholder="Longitude" required>
            @error('longitude')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="inputAddress"
          value="{{$laykes->alamat}}" placeholder="Alamat Lengkap" required>
          @error('alamat')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
        ...
        <div class="form-group">
          ...
          <select id="inputState" class="form-control @error('id_kecamatan') is-invalid @enderror"
        ...
        <div class="form-group">
          ...
          id="inputAddress2" value="{{$laykes->no_telpon}}" placeholder="No. Telpon" required>
          @error('no_telpon')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
