...
@section('title', 'Data Kasus Per Kotamadya')
@push('page-styles')
...
@section('content')
    ...
    <div class="section-body">
      <div>
        ...
        <a href="{{ route('petugas.pasien-download-kota') }}" class="btn btn-primary fas fa-file-pdf"> Export</a>
    </div>
    <br>
        {{-- <div class="card">
          <div class="card-body"> --}}
            <div class="table-responsive">
              <table class="table table-striped table-bordered" id="data_rumahsakitKota">
                ...
                <tbody>
                  @foreach ($pasien_wilayah as $data)
                      <tr>
